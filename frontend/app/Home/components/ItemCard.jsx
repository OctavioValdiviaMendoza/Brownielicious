...
export default function ItemCard({ bgImage, itemImage, itemName, itemDescription, side }) {

    if (side === 'left') {

        return (
            <div className={`w-9/12 flex flex-row justify-center 
        gap-10 rounded-xl transition-shadow hover:shadow-2xl hover:shadow-black/60 m-15`}
